import { CREATE_DATA, DELETE_DATA, NO_DATA, READ_ALL_DATA, READ_SINGLE_DATA, UPDATE_DATA } from "../types/index";
...
export const readSingleAction = (id) => ({ type: READ_SINGLE_DATA, payload: id });
